...
public class StrongSwanApplication
{
  ...
  public StrongSwanApplication(Context appContext){
		StrongSwanApplication.mContext = appContext;
		...
		appContext.registerReceiver(mRestrictionsReceiver, restrictionsFilter);
	}
